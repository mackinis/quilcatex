  ...
  const renderMap = () => {
    ...
    return (
      <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}>
          <ClientMap position={{ lat: finalSettings.lat, lng: finalSettings.lng }} onMapLoad={setMapInstance} />
      </APIProvider>
    )
  }
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <Card className="h-full flex flex-col">
           ...
           <div className="min-h-[400px] md:min-h-full w-full rounded-lg overflow-hidden shadow-lg">
             {renderMap()}
           </div>
        </div>
      </div>
